...
from app.api.endpoints import login, user, webhook, message, site, subscribe, \
    ...
    transfer, mediaserver, bangumi, storage, discover, recommend, workflow, torrent, mcp, mfa, wrapped
...
api_router.include_router(wrapped.router, prefix="/wrapped", tags=["wrapped"])
